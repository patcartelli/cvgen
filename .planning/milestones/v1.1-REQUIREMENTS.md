# Requirements Archive: v1.1 Typography & Workflow Improvements
...
- [x] **OUTPUT-01**: CLI asks the user whether the resume is tailored for a specific company; if yes, prompts for the company name — closed 2026-07-30
- [x] **OUTPUT-02**: Both PDFs are written to `output/` (not tailored) or `output/<Company-Name>/` (tailored), relative to cwd, creating the directory if needed — closed 2026-07-30
...
- [x] **QUAL-03**: User can install and run `cvgen` as a global command via `npm install -g` or `npm link` — closed 2026-07-31
...
| OUTPUT-01 | Phase 6 | Complete — 2026-07-30 |
| OUTPUT-02 | Phase 6 | Complete — 2026-07-30 |
| QUAL-01 | Phase 7 | Complete — 2026-07-28 |
| QUAL-02 | Phase 7 | Complete — 2026-07-28 |
| QUAL-03 | Phase 7 | Complete — 2026-07-31 |
